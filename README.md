...
* Implements FE à la Stata, basically ensuring that the sum of unobserved heterogeneity intercepts sum to 0, which eases interpretation. See details [here](www.stata.com/support/faqs/statistics/intercept-in-fixed-effects-model)